...
class UIComponents:
    ...
    def open_date_picker(self):
        ...
        Button(btn_frame, text="OK", command=select_date, bg='#28a745', fg='white', padx=20, pady=5).pack(side=LEFT, padx=5)
        Button(btn_frame, text="Anuluj", command=cancel, bg='#6c757d', fg='white', padx=20, pady=5).pack(side=LEFT, padx=5)
